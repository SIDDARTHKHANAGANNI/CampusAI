    ...
    <div className="space-y-6">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-amber-600 mt-0.5">This feature will analyze your resume for ATS compatibility and provide actionable feedback.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-stone-200 p-6 space-y-4">
        ...
        <div>
          <label className="text-sm font-medium text-stone-500 mb-1.5 block">Job Description (optional)</label>
          <textarea rows={4} className="w-full bg-stone-50 border border-stone-200 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-violet-200 focus:border-violet-400 transition-all text-sm resize-none" placeholder="Paste the job description here..." />
        </div>
