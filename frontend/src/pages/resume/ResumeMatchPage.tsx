    ...
    <div className="space-y-6">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-amber-700 mt-0.5">This feature will compare your resume with a job description and identify skill gaps.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
        ...
        <div>
          <label className="text-sm font-medium text-slate-600 mb-1.5 block">Job Description</label>
          <textarea rows={5} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-slate-300 focus:border-slate-400 transition-all text-sm resize-none" placeholder="Paste the complete job description here..." />
        </div>
