    ...
    <div className="min-h-screen bg-[#faf8f6] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-8">
          <h2 className="text-2xl font-semibold text-stone-800 mb-1">Create account</h2>
          <p className="text-stone-400 text-sm mb-6">Get started with CampusAI</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="text-sm font-medium text-stone-500 mb-1.5 block">Full Name</label>
              <input
                type="text"
                {...register("name")}
          ...
          <p className="text-center text-sm text-stone-400 mt-6">
            ...
            <Link to="/login" className="text-violet-500 font-medium hover:text-violet-600">
              Sign in
            </Link>
          </p>
        </div>
